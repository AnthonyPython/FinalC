...
void CTFWeaponInfo::Parse( KeyValues *pKeyValuesData, const char *szWeaponName )
{
	...
	m_WeaponData[TF_WEAPON_PRIMARY_MODE].m_flRecoil				= pKeyValuesData->GetFloat("Recoil", 0.0f);
	...
	m_WeaponData[TF_WEAPON_SECONDARY_MODE].m_flRecoil			= pKeyValuesData->GetFloat("Secondary_Recoil", m_WeaponData[TF_WEAPON_PRIMARY_MODE].m_flRecoil);
